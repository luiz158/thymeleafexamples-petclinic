thProtocol = "";
thRelativeRootPath = "../..";
thPath = "WEB-INF/thymeleaf";
thMessagePath = "../resources/messages";
thMessagesBaseName = "messages";
thExtendedMapping = true;

var localPath = thPath + "/";
thIndexFile = localPath + "welcome.html";
var pathToScripts = thymol.location + "dialect/";
...
thymol.ready(function () {
  thymol.configurePreExecution(function () {
    ...
    thymol.ThUtils.loadScript(pathToScripts + "method-attribute.js");
    thymol.addDialect({
      prefix : 'th',
      attributeProcessors : [
        { name : 'method',
...
( function() {
  ...
  thMappings = (typeof thMappings !== "undefined") ? thMappings.concat( mappingsBlock ): mappingsBlock;
  ...
  thVars = (typeof thVars !== "undefined") ? thVars.concat( varsBlock ): varsBlock;
